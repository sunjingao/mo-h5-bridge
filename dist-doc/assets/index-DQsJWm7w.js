import{i as r,B as h,C as d}from"./main-BGElYHFq.js";import{d as m,r as g,o as t,c,b as s,e as n,w as e,u as _,a}from"./index-CJ5RkvpH.js";/* empty css                                                            */const j=m({__name:"index.md.Virtualf9e47842",setup(i){r();async function l(){h.navigateTo({url:"/pages/esign/index?aa=111"})}return(o,E)=>{const p=g("m-button");return t(),c("div",null,[s(" 在console中查看 "),n(p,{onClick:l},{default:e(()=>[s("检验")]),_:1})])}}}),u={class:"marked-body"},A=a("h2",{id:"navigateto"},"navigateTo",-1),C=a("p",null,"跳转到非tabBar中的某一页",-1),B=a("h3",{id:"使用说明"},"使用说明",-1),f=a("ul",null,[a("li",null,"以微信小程序的api为准")],-1),k=a("pre",{class:"language-xml"},[a("code",{class:"hljs"},[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
