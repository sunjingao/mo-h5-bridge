import{i as p,B as h,C as d}from"./main-CDSvNpZU.js";import{d as m,r as j,o as c,c as o,b as s,e,w as l,u as _,a}from"./index-towIFY1s.js";/* empty css                                                            */const g=m({__name:"index.md.Virtual341275b0",setup(i){p();async function t(){let n=await h.getArea();console.log(n)}return(n,k)=>{const r=j("m-button");return c(),o("div",null,[s(" 在console中查看 "),e(r,{onClick:t},{default:l(()=>[s("检验")]),_:1})])}}}),u={class:"marked-body"},A=a("h2",{id:"getarea"},"getArea",-1),C=a("p",null,"获取区域",-1),B=a("h3",{id:"使用说明"},"使用说明",-1),f=a("pre",{class:"language-xml"},[a("code",{class:"hljs"},[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`),a("span",{class:"hljs-keyword"},"async"),s(),a("span",{class:"hljs-keyword"},"function"),s(),a("span",{class:"hljs-title function_"},"handleCheck"),s("("),a("span",{class:"hljs-params"}),s(`) {
  `),a("span",{class:"hljs-keyword"},"let"),s(" areas = "),a("span",{class:"hljs-keyword"},"await"),s(),a("span",{class:"hljs-title class_"},"Bridge"),s("."),a("span",{class:"hljs-title function_"},"getArea"),s(`();
  `),a("span",{class:"hljs-variable language_"},"console"),s("."),a("span",{class:"hljs-title function_"},"log"),s(`(areas);
}
`)]),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"script"),s(">")])])],-1),v={__name:"index",setup(i){return(t,n)=>(c(),o("div",u,[A,C,B,e(_(d),{code:"%3Ctemplate%3E%0A%3Cdiv%3E%0A%20%20%20%20%E5%9C%A8console%E4%B8%AD%E6%9F%A5%E7%9C%8B%0A%20%20%20%20%3Cm-button%20%40click%3D%22handleCheck%22%3E%E6%A3%80%E9%AA%8C%3C%2Fm-button%3E%0A%3C%2Fdiv%3E%0A%3C%2Ftemplate%3E%0A%3Cscript%20lang%3D%22ts%22%20setup%3E%0Aimport%20%7B%20initBridge%2C%20Bridge%20%7D%20from%20'%40%2Fmain'%0A%0AinitBridge()%0A%0Aasync%20function%20handleCheck()%20%7B%0A%20%20let%20areas%20%3D%20await%20Bridge.getArea()%3B%0A%20%20console.log(areas)%3B%0A%7D%0A%3C%2Fscript%3E"},{code:l(()=>[f]),default:l(()=>[e(g)]),_:1})]))}};export{v as default};
