import{i as p,B as d,C as h}from"./main-BGElYHFq.js";import{d as m,r as _,o as l,c,b as s,e as n,w as e,u as j,a}from"./index-CJ5RkvpH.js";/* empty css                                                            */const u=m({__name:"index.md.Virtualb4ed9ce7",setup(i){p();async function t(){d.redirectTo()}return(o,E)=>{const r=_("m-button");return l(),c("div",null,[s(" 在console中查看 "),n(r,{onClick:t},{default:e(()=>[s("检验")]),_:1})])}}}),g={class:"marked-body"},C=a("h2",{id:"redirectto"},"redirectTo",-1),A=a("p",null,"重定向到某页",-1),B=a("h3",{id:"使用说明"},"使用说明",-1),f=a("ul",null,[a("li",null,"以微信小程序的api为准")],-1),k=a("pre",{class:"language-xml"},[a("code",{class:"hljs"},[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`),a("span",{class:"hljs-keyword"},"async"),s(),a("span",{class:"hljs-keyword"},"function"),s(),a("span",{class:"hljs-title function_"},"handleCheck"),s("("),a("span",{class:"hljs-params"}),s(`) {
  `),a("span",{class:"hljs-title class_"},"Bridge"),s("."),a("span",{class:"hljs-title function_"},"redirectTo"),s(`();
}
`)]),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"script"),s(">")])])],-1),y={__name:"index",setup(i){return(t,o)=>(l(),c("div",g,[C,A,B,f,n(j(h),{code:"%3Ctemplate%3E%0A%3Cdiv%3E%0A%20%20%20%20%E5%9C%A8console%E4%B8%AD%E6%9F%A5%E7%9C%8B%0A%20%20%20%20%3Cm-button%20%40click%3D%22handleCheck%22%3E%E6%A3%80%E9%AA%8C%3C%2Fm-button%3E%0A%3C%2Fdiv%3E%0A%3C%2Ftemplate%3E%0A%3Cscript%20lang%3D%22ts%22%20setup%3E%0Aimport%20%7B%20initBridge%2C%20Bridge%20%7D%20from%20'%40%2Fmain'%0A%0AinitBridge()%0A%0Aasync%20function%20handleCheck()%20%7B%0A%20%20Bridge.redirectTo()%3B%0A%7D%0A%3C%2Fscript%3E"},{code:e(()=>[k]),default:e(()=>[n(u)]),_:1})]))}};export{y as default};
