import{i as r,B as h,C as d}from"./main-BGElYHFq.js";import{d as m,r as _,o as l,c,b as s,e as n,w as t,u as j,a}from"./index-CJ5RkvpH.js";/* empty css                                                            */const u=m({__name:"index.md.Virtual8e252ea9",setup(i){r();async function e(){h.navigateBack()}return(o,E)=>{const p=_("m-button");return l(),c("div",null,[s(" 在console中查看 "),n(p,{onClick:e},{default:t(()=>[s("检验")]),_:1})])}}}),g={class:"marked-body"},B=a("h2",{id:"navigateback"},"navigateBack",-1),C=a("p",null,"返回上一页",-1),k=a("h3",{id:"使用说明"},"使用说明",-1),A=a("ul",null,[a("li",null,"以微信小程序的api为准")],-1),f=a("pre",{class:"language-xml"},[a("code",{class:"hljs"},[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
