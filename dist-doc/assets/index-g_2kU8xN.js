import{i as h,B as r,C as d}from"./main-CDSvNpZU.js";import{d as m,r as _,o as e,c,b as s,e as n,w as l,u as j,a}from"./index-towIFY1s.js";/* empty css                                                            */const u=m({__name:"index.md.Virtual12b43ced",setup(i){h();async function t(){r.switchTab({url:"/pages/home/index"})}return(o,k)=>{const p=_("m-button");return e(),c("div",null,[s(" 在console中查看 "),n(p,{onClick:t},{default:l(()=>[s("检验")]),_:1})])}}}),g={class:"marked-body"},A=a("h2",{id:"switchtab"},"switchTab",-1),C=a("p",null,"跳转到tabBar中的某一页",-1),B=a("h3",{id:"使用说明"},"使用说明",-1),f=a("ul",null,[a("li",null,"以微信小程序的api为准")],-1),b=a("pre",{class:"language-xml"},[a("code",{class:"hljs"},[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
